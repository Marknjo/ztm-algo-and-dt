...
class BinarySearchTree {
  ...
  BFSWithRecursion(queue, list) {
    ...
    return this.BFSWithRecursion(queue, list);
  }
}
...
const BFSLoops = tree.BFSWithLoops();

console.log(BFSLoops);

console.log(
  "\n\n-------------------------BFS ALGO RECURSION-------------------------\n"
);
const BFSRecursion = tree.BFSWithRecursion([tree.parentNode], []);
console.log(BFSRecursion);
